...
Plugin URI: http://twincitiestech.com
...
/** Path for Includes */
define('WPP_Path', WP_PLUGIN_DIR . '/wp-properties');

/** Path for front-end links */
define('WPP_URL', WP_PLUGIN_URL . '/wp-properties');

/** Directory path for includes of template files  */
define('WPP_Templates', WP_PLUGIN_DIR . '/wp-properties/templates');

/** Directory path for includes of template files  */
define('WPP_Premium', WP_PLUGIN_DIR . '/wp-properties/core/premium');
