...
Usafe of custom attributes added in the Developer tab for queries, example:
...
And as of version 1.02 you can use the shortcode to select a template for property overview, like so:
...
* Perofrmance improvement in get_properties() function by commenting out log

= 1.02 =
* [property_overview template=my_template] will load  property-overview-my_templane.php from your theme folder instead of property_overview.php
