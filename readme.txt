...
As of version 0.60 we have added a "Developer" tab to the settings page which lets you create new property types, real estate listings for example, alongsite rental properties.
