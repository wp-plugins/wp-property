...
<div class="property_div <?php echo $property[post_type]; ?> clearfix">
 	<div class="property_image">
		...
		?>
		<a href="<?php echo $thumbnail_link; ?>" class="property_overview_thumb property_overview_thumb_<?php echo $thumbnail_size; ?> <?php echo $link_class; ?>" rel="properties" >
			<img src="<?php echo $property[$thumbnail_size]; ; ?>" alt="<?php echo $property[post_title];?>" />
		</a>
 	</div>
	...
	<div class="top_row">
		<div class="property_tagline">
			...
			<?php echo "at <a href='{$property[parent_link]}'>{$property[parent_title]}</a>"; ?>
			<?php endif; ?>
