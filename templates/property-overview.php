...
<div class="property_div <?php echo $property[post_type]; ?> clearfix">
	...
	<div class="top_row">
		...
		<span class="property_phone_number"><?php echo apply_filters('wpp_stat_filter_phone_number',$property[phone_number]); ?></span>
		<?php endif; ?>
		<?php if(!empty($property[display_address])): ?>
		<span class="property_address"><a href="<?php echo $property[permalink]; ?>?show=location"><?php echo apply_filters('wpp_stat_filter_display_address', $property[display_address]); ?></a></span>
		<?php endif; ?>
		
		<?php if(!empty($property[price])): ?>
		<span class="property_price"><?php echo apply_filters('wpp_stat_filter_price',$property[price]); ?></span>
		<?php endif; ?>
