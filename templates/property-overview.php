...
<div class="property_div <?php echo $property['post_type']; ?> clearfix">
	...
	<div class="wpp_overview_left_column" style="width: <?php echo($thumbnail_sizes[width] + 10); ?>px;">
	...
	<div class="wpp_overview_right_column" style="margin-left:-<?php echo($thumbnail_sizes['width'] + 10); ?>px;">
	
		<ul class="wpp_overview_data" style="margin-left:<?php echo($thumbnail_sizes['width'] + 20); ?>px;">
