...
<?php the_post(); ?>
   ...
   <script type="text/javascript">
	...
	function initialize() {
		...
		var myLatlng = new google.maps.LatLng(<?php echo $post->latitude; ?>,<?php echo $post->longitude; ?>);
		var myOptions = {
		...
		var infowindow = new google.maps.InfoWindow({
			content: '<table cellpadding=0 cellspacing=0><tr><td width="110"><img style="margin:0;padding:0;" src="<?php echo $post->tiny_thumb;?>" alt="Apartment" /></td><td width="200" valign="top"><b><?php echo $post->location; ?></b><br /><br /><a target="_blank" href="http://maps.google.com/maps?gl=us&daddr=<?php echo str_replace(' ','+', $post->location); ?>">Get Directions</a></td></tr></table>'
		});
	...
	<div id="container">
		<div id="content" role="main" class="property_content">
			...
			<div class="entry-content">
				...
				<?php draw_stats('exclude=location'); ?>
				</div>
