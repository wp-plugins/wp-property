<?php
	...
	function wpp_property_stats_input_for_rent_make_checkbox($content, $slug, $object) {
		...
		return "<input type='checkbox' id='wpp_meta_{$slug}' name='wpp_data[meta][{$slug}]'  value='true' $checked /> <label for='wpp_meta_{$slug}'>This is a rental property.</label>";
	}
	
		
	function wpp_property_stats_input_for_sale_make_checkbox($content, $slug, $object) {
		$checked = (get_post_meta($object->ID, $slug, true) == 'true' ? ' checked="true" ': false);
		return "<input type='checkbox' id='wpp_meta_{$slug}' name='wpp_data[meta][{$slug}]'  value='true' $checked /> <label for='wpp_meta_{$slug}'>This property is for sale.</label>";
	}
