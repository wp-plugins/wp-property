...
if(!function_exists('draw_property_search_form')):
	function draw_property_search_form($search_attributes = false) {
		...
		?>
            <form action="<?php echo  get_bloginfo('url') . "/". $wp_properties['configuration']['base_slug']; ?>" method="post">
				...
				<?php if(is_array($search_values[bedrooms]) && in_array('bedrooms', $search_attributes)): ?>
				<li>
				...
				<?php if(is_array($search_values[city]) && in_array('city', $search_attributes)): ?>
				<li>
				...
				<?php if(is_array($search_values[price]) && in_array('price', $search_attributes)): ?>
				<li>
