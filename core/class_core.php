...
class WPP_Core {
	...
	function WPP_Core(){
		...
		wp_register_script('wp-property-admin-overview', WPP_URL. '/js/wp-property-admin-overview.js', array('jquery'), '1.09' );
		wp_register_script('wp-property-global', WPP_URL. '/js/wp-property-global.js', array('jquery'), '1.09' );
		...
		if ( file_exists( STYLESHEETPATH . '/wp_properties.css') ) {
			wp_register_style('wp-property-frontend', get_bloginfo('stylesheet_directory') . '/wp_properties.css',   array(),'1.09' );
		} elseif (file_exists( TEMPLATEPATH . '/wp_properties.css')) {
			wp_register_style('wp-property-frontend', get_bloginfo('template_url') . '/wp_properties.css',  array(), '1.09' );
		} elseif (file_exists( WPP_Templates . '/wp_properties.css') && $wp_properties[configuration][autoload_css] == 'true') {
			wp_register_style('wp-property-frontend', WPP_URL . '/templates/wp_properties.css',  array(), '1.09' );
			...
			if(file_exists( WPP_Templates . "/theme-specific/{$theme_slug}.css")) {
				wp_register_style('wp-property-theme-specific', WPP_URL . "/templates/theme-specific/{$theme_slug}.css",  array('wp-property-frontend'), '1.09' );
			}			
		}

		
		if ( file_exists( STYLESHEETPATH . '/wp_properties-msie.css') ) {
			wp_register_style('wp-property-frontend-msie', get_bloginfo('stylesheet_directory') . '/wp_properties-msie.css',   array(),'1.09' );
		} elseif ( file_exists( TEMPLATEPATH . '/wp_properties-msie.css') ) {
			wp_register_style('wp-property-frontend-msie', get_bloginfo('template_url') . '/wp_properties-msie.css',   array(),'1.09' );
		} elseif (file_exists( WPP_Templates . '/wp_properties-msie.css') && $wp_properties[configuration][autoload_css] == 'true') {
			wp_register_style('wp-property-frontend-msie', WPP_URL . '/templates/wp_properties-msie.css',  array(), '1.09' );
		}
		...
		if ( file_exists( STYLESHEETPATH . '/wp_properties.js') ) {
			wp_register_script('wp-property-frontend', get_bloginfo('stylesheet_directory') . '/wp_properties.js', array(),'1.09' );
 		} elseif( file_exists( TEMPLATEPATH . '/wp_properties.js') ) {
			wp_register_script('wp-property-frontend', get_bloginfo('template_url') . '/wp_properties.js', array(),'1.09' );
 		} elseif (file_exists( WPP_Templates . '/wp_properties.js')) {
			wp_register_script('wp-property-frontend', WPP_URL . '/templates/wp_properties.js', array(), '1.09' );
 		}
...
*/
    ...
    function shortcode_property_overview($atts = "")  {
        ...
        if(empty($props_atts['ajax_call']) && $atts['pagination'] != 'off') {
