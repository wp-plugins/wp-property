...
class WPP_Core {
	...
	function WPP_Core(){
		...
		wp_register_script('wp-property-admin-overview', WPP_URL. '/js/wp-property-admin-overview.js', array('jquery'), '1.7.3' );
	...
	function admin_enqueue_scripts($hook) {
		...
		if($current_screen->id == 'edit-property') {
			...
			.wpp_overview .column-featured {width: 60px;}
			.wpp_overview td.column-featured {text-align: center; }
			</style>
			<?php
			endif; 
