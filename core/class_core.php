...
class WPP_Core {
	...
	function init() {
		...
		wp_register_script('wp-property-admin-overview', WPP_URL. '/js/wp-property-admin-overview.js', array('jquery'), '1.13' );
		wp_register_script('wp-property-global', WPP_URL. '/js/wp-property-global.js', array('jquery'), '1.13' );
		...
		if ( file_exists( STYLESHEETPATH . '/wp_properties.css') ) {
			...
			wp_register_style('wp-property-frontend', get_bloginfo('template_url') . '/wp_properties.css',  array(), '1.13' );
		} elseif (file_exists( WPP_Templates . '/wp_properties.css') && $wp_properties['configuration']['autoload_css'] == 'true') {
			wp_register_style('wp-property-frontend', WPP_URL . '/templates/wp_properties.css',  array(), '1.13' );
			...
			if(file_exists( WPP_Templates . "/theme-specific/{$theme_slug}.css")) {
				wp_register_style('wp-property-theme-specific', WPP_URL . "/templates/theme-specific/{$theme_slug}.css",  array('wp-property-frontend'), '1.13' );
			}
		}
		...
		if ( file_exists( STYLESHEETPATH . '/wp_properties.js') ) {
			...
			wp_register_script('wp-property-frontend', WPP_URL . '/templates/wp_properties.js', array(), '1.13' );
 		}
        ...
        if ($single_page || $wp_query->is_property_overview)	{
			...
			foreach($conditional_styles as $type) {
				...
				if ( file_exists( STYLESHEETPATH . "/wp_properties-{$url_slug}.css") ) {
					...
					wp_register_style('wp-property-frontend-'. $url_slug, WPP_URL . "/templates/wp_properties-{$url_slug}.css",  array('wp-property-frontend'), '1.13' );
				}
