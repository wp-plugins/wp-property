		...
		<tr>
			...
			<td>
				...
				<?php  foreach($wp_properties['property_types'] as $property_slug => $label):  ?>
					...
					<tr class="wpp_dynamic_table_row <?php echo $hidden; ?>" slug="<?php echo $property_slug; ?>"  new_row='false'>
					<td >
		...
		<tr>
			...
			<td>
				...
				<?php  foreach($wp_properties['property_stats'] as $slug => $label):  ?>
					...
					<tr class="wpp_dynamic_table_row <?php echo $hidden; ?>" slug="<?php echo $slug; ?>"  new_row='false'>
					<th class="wpp_draggable_handle">&nbsp;</th>
					...
					<td>
						<select name="wpp_settings[searchable_attr_fields][<?php echo $slug; ?>]">
							<option value="input" <?php if($wp_properties['searchable_attr_fields'][$slug] == 'input') echo "selected=\"selected\""; ?>><?php _e('input','wpp') ?></option>
							<option value="range_input" <?php if($wp_properties['searchable_attr_fields'][$slug] == 'range_input') echo "selected=\"selected\""; ?>><?php _e('range (input)','wpp') ?></option>
							<option value="range_dropdown" <?php if($wp_properties['searchable_attr_fields'][$slug] == 'range_dropdown') echo "selected=\"selected\""; ?>><?php _e('range (dropdown)','wpp') ?></option>
							<option value="dropdown" <?php if($wp_properties['searchable_attr_fields'][$slug] == 'dropdown') echo "selected=\"selected\""; ?>><?php _e('dropdown','wpp') ?></option>
							<option value="checkbox" <?php if($wp_properties['searchable_attr_fields'][$slug] == 'checkbox') echo "selected=\"selected\""; ?>><?php _e('checkbox','wpp') ?></option>
						</select>
					</td>
