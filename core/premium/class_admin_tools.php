...
add_action('wpp_init', array('WPP_Admin_Tools', 'init'));
...
class WPP_Admin_Tools {
	...
	function init() {	
		...
		add_filter('wpp_settings_nav', array('WPP_Admin_Tools', 'settings_nav'));

		// Add Settings Page
		add_action('wpp_settings_content_admin_tools', array('WPP_Admin_Tools', 'settings_page'));
