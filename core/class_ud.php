...
class UD_UI {
	...
	function show_log_page() {
		...
		?>
		<div class="wrap">
		<h2>UD Log Page for get_option('<?php echo UD_PREFIX . 'log'; ?>');</h2>
...
class UD_F {
	...
	**/
	...
	function add_log_page() {
		add_action('admin_menu', create_function('', "add_menu_page('UD Log', 'UD Log', 10, 'ud_log', array('UD_UI','show_log_page'));"));	
	}
