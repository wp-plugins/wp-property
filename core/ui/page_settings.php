...
<div id="wpp_settings_tabs" class="clearfix">
	...
	<div id="tab_main">
		...
		<tr>
			...
			<td>
				Attribute to use for address: <?php echo WPP_F::draw_attribute_dropdown("name=wpp_settings[configuration][address_attribute]&selected={$wp_properties[configuration][address_attribute]}"); ?>
			</td>
		</tr>
		...
		<tr>
			<th>Currency</th>
			<td>
				<?php echo UD_UI::input("name=currency_symbol&label=Currency symbol.&group=wpp_settings[configuration]&style=width: 50px;",$wp_properties[configuration][currency_symbol]); ?>
			</td>
		</tr>
	...
	<div id="tab_display">
		...
		<tr>
			...
			<td>
				...
				The display settings may be edited further by customizing the <b>wp-content/plugins/wp-properties/templates/property-overview.php</b> file.  To avoid losing your changes during updates, create a <b>property-overview.php</b> file in your template directory, which will be automatically loaded.
				<ul>
		...
		<tr>
			...
			<td>
				...
				The display settings may be edited further by customizing the <b>wp-content/plugins/wp-properties/templates/property.php</b> file.  To avoid losing your changes during updates, create a <b>property.php</b> file in your template directory, which will be automatically loaded.
				<ul>
		...
		<tr>
			...
			<td>
				...
				Available tags: [street_number] [street_name], [city], [state], [state_code], [country], [zip_code].
				</span>
			</td>
		</tr>
					...
					<td valign="top">
						...
						<div class="wpp_box_footer clearfix">
							<?php if($installed): ?>
								...
								<div class="alignleft">
								<?php echo UD_UI::checkbox("name=wpp_settings[installed_features][$plugin_slug][disabled]&label=Disable plugin.", $wp_properties[installed_features][$plugin_slug][disabled]); ?>
								</div>

								<div class="alignright">Feature installed, using version <?php echo $wp_properties[installed_features][$plugin_slug][version]; ?>.</div>
							<?php else: ?>
								Please visit <a href="http://twincitiestech.com/plugins/wp-property/premium/">TwinCitiesTech.com</a> to purchase this feature.
							<?php endif; ?>
						</div>
						</div>
					</td>
...
<?php endif; ?>
	...
	<div id="tab_troubleshooting">
		<div class="wpp_inner_tab">
			...
			<p>Force check of allowed premium features.
 				<input type="button" value="Check Updates" id="wpp_ajax_check_plugin_updates">
			</p>
