...
if (!is_writable(WPP_Premium . "/index.php"))
...
<div id="wpp_settings_tabs" class="clearfix">
	...
	<div id="tab_main">
		...
		<tr>
			...
			<td>
				<?php 
            $insert_property_text = __('Automatically insert property overview into property page content.','wpp');
		...
		<tr>
            ...
            echo UD_UI::input("name=phone_number&label=$phone_number_text&group=wpp_settings[configuration]&style=width: 200px;&value={$wp_properties[configuration][phone_number]}"); ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<ul>
                  ...
                  echo UD_UI::checkbox("name=wpp_settings[configuration][property_overview][fancybox_preview]&label=$show_larger_img_text", $wp_properties['configuration']['property_overview']['fancybox_preview']); ?></li>
 				</ul>
