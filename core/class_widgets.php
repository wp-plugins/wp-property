 ...
 */
 class ChildPropertiesWidget extends WP_Widget {
    ...
    function ChildPropertiesWidget() {
        ...
        parent::WP_Widget(false, $name = __('Child Properties','wpp'));
    }
    ...
    function form($instance) {
		...
		if(empty($address_format))
          ...
          ?>
			<p><?php __('The widget will not be displayed if the currently viewed property has no children.','wpp'); ?></p>
            <p>
			...
			<p><?php __('Select the stats you want to display','wpp'); ?></p>
 ...
 */
 class FeaturedPropertiesWidget extends WP_Widget {
    ...
    function FeaturedPropertiesWidget() {
        parent::WP_Widget(false, $name = __('Featured Properties','wpp'));
    }
 ...
 */
 class SearchPropertiesWidget extends WP_Widget {
    ...
    function SearchPropertiesWidget() {
        parent::WP_Widget(false, $name = __('Property Search','wpp'));
    }
          ...
          ?>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('searchable_property_types'); ?>_<?php echo $property_type; ?>">
 					<input id="<?php echo $this->get_field_id('searchable_property_types'); ?>_<?php echo $property_type; ?>" name="<?php echo $this->get_field_name('searchable_property_types'); ?>[]" type="checkbox" value="<?php echo $property_type; ?>" <?php if(is_array($searchable_property_types) && in_array($property_type, $searchable_property_types)) { echo " checked "; } ?> />
 ...
 */
 class GalleryPropertiesWidget extends WP_Widget {
    ...
    function GalleryPropertiesWidget() {
        parent::WP_Widget(false, $name = __('Property Gallery','wpp'));
    }
