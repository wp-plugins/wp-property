 ...
 */
 class OtherPropertiesWidget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        echo $before_widget;
        echo "<div id='wpp_other_properties_widget'>";
...
jQuery(document).ready(function($){
	$('input.check_me_other').change(function(){
		if($(this).attr('checked') !== true){
			$('p#choose_thumb_other').css('display','block');
		}else{
			$('p#choose_thumb_other').css('display','none');
		}
	})
});
</script>
