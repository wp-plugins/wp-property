...
*/
	...
	$wp_properties['available_plugins'] = array(
		'slideshow' => array(
			'title' => 'Slideshow', 
			'tagline' => 'A slideshow for every property page, home page, or both. ', 
			'image' => 'http://twincitiestech.com/wp-content/uploads/Slideshow-Image-Selection.jpg', 
			'description' => 'The slideshow feature allows you to insert a slideshow into any property page, home page, or virtually anywhere in your blog. <br /> <br />We made it extremely simple - the slideshow page searches through the Media Library looking for images that are big enough for the slideshow - dimensions to which you would specify in the main WP-Property control panel.<br /><br />The applicable images are all listed in the left panel (as see in the screenshot).  To add images to the main slideshow, simply drag and drop the images you want, in the correct order, to the right "Slideshow Images" panel.'
			),
		'inquiry' => array(
			'title' => 'Inquiry', 
			'tagline' => 'Keep track of all your prospects and leads in an organized manner.', 
			'image' => 'http://twincitiestech.com/wp-content/uploads/Front-Apartment-Page-250x160.jpg', 
			'description' => 'The inquiry plugin lets you keep close track of prospects expressing interest in your properties.  After an inquiry form is filled out and submitted, a user profile is created for the lead that lets you send them newsletters, invoices, text message reminders, etc.'
			),
		'super_map' => array(
			'title' => 'Super Map', 
			'tagline' => 'Interactive map giving your potential tennants a lot information in one place.', 
			'image' => 'http://twincitiestech.com/wp-content/uploads/Front-Viewing-Apartment-with-Popup-Open-250x160.jpg', 
			'description' => 'Super Map plugin lets you put a large interactive map virtually anywhere in your WordPress setup.  The map lets your visitors quickly view the location of all your properties, nearby attractions, schools, etc.'
			),
		'admin_tools' => array(
			'title' => 'Admin Tools', 
			'tagline' => 'For developers and designers needing to streamline their development involving WP-Property.', 
			'image' => 'http://twincitiestech.com/wp-content/uploads/Media-Library-250x160.jpg', 
			'description' => 'This plugin is intended for developers and theme designers.  The plugin can generate fake properties, user requests, etc. to assist with developing themes.'
			)
	);
	*/
